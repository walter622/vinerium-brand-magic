          ...
          <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-5 py-12 sm:px-8">
            <div className="max-w-2xl text-white">
              <h1 className="font-display text-[2.25rem] leading-[1.05] sm:text-6xl lg:text-7xl">
                Vinhos importados de <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">pequenas produções</em> com <em className="not-italic italic">preço de atacado</em> para quem compra em <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">volume</em>
              </h1>
        ...
        <div className="mx-auto max-w-5xl px-5 sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl leading-tight text-white sm:text-5xl">
              Assista ao vídeo e entenda como comprar vinhos importados com <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">curadoria, procedência e preço de atacado</em>
            </h2>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-14 sm:gap-12 sm:px-8 sm:py-20 lg:grid-cols-[1fr_1.1fr] lg:py-24">
          ...
          <div>
            <h2 className="font-display text-3xl leading-tight sm:text-5xl">
              O mercado está cheio de <em className="italic">vinhos genéricos</em>. A sua seleção <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">não precisa ser mais do mesmo</em>
            </h2>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-8 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl leading-tight sm:text-5xl">
              <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">Acesso antecipado</em> a condições, rótulos e seleções especiais
            </h2>
            <p className="mt-6 text-base leading-relaxed text-white/85 sm:text-lg">
      ...
      <section className="relative isolate overflow-hidden bg-brand-night text-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center px-5 py-24 text-center sm:px-8">
          ...
          <h2 className="mt-6 font-display text-3xl leading-tight sm:text-6xl">
            Pronto para acessar vinhos importados com <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">preço de atacado</em> e <em className="not-italic font-bold text-[color:var(--color-brand-wine)]">curadoria premium</em>?
          </h2>
